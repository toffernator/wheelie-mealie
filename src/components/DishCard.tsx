  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="font-sans flex flex-row">
        <p>F: {props.NutritionData.fat.value.toString() + props.NutritionData.fat.unit + " |"} </p>
        <p>C: {props.NutritionData.carbs.value.toString() + props.NutritionData.carbs.unit + " | "}</p>
        <p>P: {props.NutritionData.protein.value.toString() + props.NutritionData.protein.unit + " | "}</p>
